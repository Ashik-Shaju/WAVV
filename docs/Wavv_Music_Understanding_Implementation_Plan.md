...
- One MTG/Jamendo track was temporarily downloaded in each of four formats for the codec pilot; all four files were deleted after feature extraction. No dataset audio is retained. Results are in [`audio_format_pilot.json`](../music%20understanding/reports/audio_format_pilot.json). No training entry point has been added and no training has run.
